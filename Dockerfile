...
# Atualiza a lista de pacotes e instala o Chromium e ferramentas de debug (Alpine Linux usa apk)
RUN apk update && apk add --no-cache chromium curl wget net-tools && rm -rf /var/cache/apk/*
